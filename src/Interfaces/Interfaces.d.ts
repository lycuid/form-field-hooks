...
declare namespace Field {
    ...
    interface InputAttributes extends React.InputHTMLAttributes<HTMLInputElement>, ObjectInterface {
        value?: string;
        onChange?: Types.Void;
    }
    /** valid HTML DOM TextArea element attributes */
    interface TextAreaAttributes extends React.TextareaHTMLAttributes<HTMLTextAreaElement>, ObjectInterface {
        value?: string;
        onChange?: Types.Void;
    }
    /** valid HTML DOM Select element attributes */
    interface SelectAttributes extends React.SelectHTMLAttributes<HTMLSelectElement>, ObjectInterface {
        value?: string | string[];
    ...
    type HTMLGenericAttributes = InputAttributes | TextAreaAttributes | SelectAttributes | CheckboxAttributes;
    /**
    ...
    interface FormInputProps extends InputAttributes, FormElementProps<InputElement> {
    }
    interface FormTextAreaProps extends TextAreaAttributes, FormElementProps<TextAreaElement> {
    }
    ...
    interface FormSelectProps extends FormElementProps<SelectElement>, SelectAttributes {
        /**
    ...
    type GenericElement = InputElement | TextAreaElement | SelectElement | RadioElements;
}
